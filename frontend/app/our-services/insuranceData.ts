...
export const INSURANCE_DATA: Record<string, InsuranceDetailData> = {
  "life-insurance": {
    ...
    stages: [
      { emoji: "/images/icons/just-starting-out.png", age: "AGE 20–30", ageColor: "text-cyan-600", title: "Just Starting Out", description: "Lock in ultra-low premiums. A ₹1 Cr term plan at 25 costs ~₹437/mo. Best time to buy is now.", linkText: "Term Insurance", linkColor: "text-blue-700", bg: "bg-gradient-to-br from-blue-50 to-white" },
      { emoji: "/images/icons/family-mortgage.png", age: "AGE 30–40", ageColor: "text-orange-500", title: "Family & Mortgage", description: "Protect spouse, kids, home loan. Increase sum assured to cover all liabilities and income replacement.", linkText: "Term + Critical Illness", linkColor: "text-orange-500", bg: "bg-gradient-to-br from-orange-50 to-white" },
      { emoji: "/images/icons/peak-earning-years.png", age: "AGE 40–55", ageColor: "text-emerald-600", title: "Peak Earning Years", description: "Focus on wealth creation alongside protection. ULIPs and endowment plans build retirement corpus.", linkText: "ULIP + Endowment", linkColor: "text-emerald-600", bg: "bg-gradient-to-br from-emerald-50 to-white" },
      { emoji: "/images/icons/legacy-planning.png", age: "AGE 55+", ageColor: "text-cyan-600", title: "Legacy Planning", description: "Pass on wealth to next generation. Whole life policies ensure estate and assets reach nominees tax-free.", linkText: "Whole Life Plan", linkColor: "text-cyan-600", bg: "bg-gradient-to-br from-cyan-50 to-white" },
    ],
  ...
  "health-insurance": {
    ...
    benefits: [
      { iconBg: "bg-teal-100", emoji: "/images/icons/cashless-hospitalisation.png", title: "Cashless Hospitalisation", description: "Get treated at any network hospital without paying upfront. The insurer settles the bill directly with the hospital." },
      { iconBg: "bg-emerald-100", emoji: "/images/icons/family-floater-cover.png", title: "Family Floater Cover", description: "One policy, one premium covers the entire family. The sum insured can be used by any member whenever needed." },
      { iconBg: "bg-blue-100", emoji: "/images/icons/pre-post-hospitalisation.png", title: "Pre & Post Hospitalisation", description: "Covers doctor consultations, tests, and medicines before admission (60 days) and after discharge (90 days)." },
      { iconBg: "bg-indigo-100", emoji: "/images/icons/day-care-procedures.png", title: "Day-Care Procedures", description: "Modern treatments like dialysis, chemotherapy, and cataract surgery that take less than 24 hours are fully covered." },
      { iconBg: "bg-rose-100", emoji: "/images/icons/critical-illness-addon.png", title: "Critical Illness Add-on", description: "Receive a lump sum on diagnosis of cancer, heart attack, stroke, or kidney failure — independent of hospitalisation." },
      { iconBg: "bg-orange-100", emoji: "/images/icons/senior-citizen-plans.png", title: "Senior Citizen Plans", description: "Specialised policies for 60+ with no medical tests up to a certain age, and covers like cataract and joint replacement." },
      { iconBg: "bg-yellow-100", emoji: "/images/icons/tax-savings-80d.png", title: "Tax Savings under 80D", description: "Save up to ₹25,000/year (₹50,000 for seniors) on health insurance premiums paid under Section 80D." },
      { iconBg: "bg-cyan-100", emoji: "/images/icons/no-claim-bonus.png", title: "No-Claim Bonus", description: "For every claim-free year, your sum insured increases by 10–50% at no extra cost — reward for staying healthy." },
    ],
    stagesBadge: "AT EVERY LIFE STAGE",
    stagesTitle: "Health needs",
    stagesTitleAccent: "evolve with age",
    stages: [
      { emoji: "/images/icons/young-independent.png", age: "AGE 18–30", ageColor: "text-teal-600", title: "Young & Independent", description: "Low premiums, high coverage. Build the habit early. A ₹5L individual plan costs under ₹5,000/year.", linkText: "Individual Health Plan", linkColor: "text-teal-600", bg: "bg-gradient-to-br from-teal-50 to-white" },
      { emoji: "/images/icons/growing-family.png", age: "AGE 30–45", ageColor: "text-blue-600", title: "Growing Family", description: "Switch to a family floater or add maternity cover. Protect spouse and children under one plan.", linkText: "Family Floater Plan", linkColor: "text-blue-600", bg: "bg-gradient-to-br from-blue-50 to-white" },
      { emoji: "/images/icons/peak-risk-years.png", age: "AGE 45–60", ageColor: "text-orange-500", title: "Peak Risk Years", description: "Add critical illness riders, increase sum insured, and choose a super top-up for extra buffer.", linkText: "Critical Illness + Top-Up", linkColor: "text-orange-500", bg: "bg-gradient-to-br from-orange-50 to-white" },
      { emoji: "/images/icons/senior-coverage.png", age: "AGE 60+", ageColor: "text-rose-600", title: "Senior Coverage", description: "Specialised senior plans with domiciliary cover, OPD benefits, and higher day-care coverage.", linkText: "Senior Citizen Plan", linkColor: "text-rose-600", bg: "bg-gradient-to-br from-rose-50 to-white" },
    ],
  ...
  "motor-insurance": {
    ...
    benefits: [
      { iconBg: "bg-orange-100", emoji: "/images/icons/own-damage-cover.png", title: "Own Damage Cover", description: "Covers repair costs for your vehicle after accidents, floods, fire, theft, and natural disasters — regardless of who is at fault." },
      { iconBg: "bg-rose-100", emoji: "/images/icons/third-party-liability.png", title: "Third-Party Liability", description: "Mandatory by law. Covers bodily injury, death, or property damage caused to a third party by your vehicle." },
      { iconBg: "bg-yellow-100", emoji: "/images/icons/cashless-garages.png", title: "Cashless Garages", description: "Get repairs done at 3,500+ network garages without paying upfront. The insurer settles the bill directly." },
      { iconBg: "bg-blue-100", emoji: "/images/icons/zero-depreciation.png", title: "Zero Depreciation", description: "Claim the full cost of parts without depreciation deduction. Get 100% value on plastic, rubber, and fibre parts." },
      { iconBg: "bg-emerald-100", emoji: "/images/icons/engine-protection.png", title: "Engine Protection", description: "Covers engine damage due to water ingression or oil leakage — scenarios not covered under standard policies." },
      { iconBg: "bg-indigo-100", emoji: "/images/icons/roadside-assistance.png", title: "Roadside Assistance", description: "24/7 support for breakdown, flat tyre, fuel delivery, towing, and locksmith services — wherever you are." },
      { iconBg: "bg-cyan-100", emoji: "/images/icons/ncb-protection.png", title: "NCB Protection", description: "Protect your earned No-Claim Bonus even after filing a claim. Don't lose years of accumulated discounts." },
      { iconBg: "bg-purple-100", emoji: "/images/icons/personal-accident-cover.png", title: "Personal Accident Cover", description: "Compulsory personal accident cover of ₹15 lakh for the owner-driver in case of death or permanent disability." },
    ],
    stagesBadge: "FOR EVERY VEHICLE TYPE",
    stagesTitle: "Motor insurance for",
    stagesTitleAccent: "every kind of driver",
    stages: [
      { emoji: "/images/icons/bikes-scooters.png", age: "TWO-WHEELERS", ageColor: "text-orange-500", title: "Bikes & Scooters", description: "New bike? Mandatory third-party + comprehensive to fully protect your ride from day one.", linkText: "Two-Wheeler Plan", linkColor: "text-orange-500", bg: "bg-gradient-to-br from-orange-50 to-white" },
      { emoji: "/images/icons/private-cars.png", age: "PRIVATE CARS", ageColor: "text-blue-600", title: "Private Cars", description: "Comprehensive plans with zero depreciation, engine protect, and roadside assistance for complete peace of mind.", linkText: "Comprehensive Car Plan", linkColor: "text-blue-600", bg: "bg-gradient-to-br from-blue-50 to-white" },
      { emoji: "/images/icons/commercial-vehicles.png", age: "COMMERCIAL", ageColor: "text-emerald-600", title: "Commercial Vehicles", description: "Goods carriers, passenger vehicles, taxis — specialised policies that cover commercial use and goods in transit.", linkText: "Commercial Vehicle Plan", linkColor: "text-emerald-600", bg: "bg-gradient-to-br from-emerald-50 to-white" },
      { emoji: "/images/icons/electric-vehicles.png", age: "ELECTRIC VEHICLES", ageColor: "text-cyan-600", title: "Electric Vehicles", description: "Specialised EV insurance covering battery, charging equipment, and roadside assistance for electric mobility.", linkText: "EV Insurance Plan", linkColor: "text-cyan-600", bg: "bg-gradient-to-br from-cyan-50 to-white" },
    ],
  ...
  "home-insurance": {
    ...
    stages: [
      { emoji: "/images/icons/apartment-units.png", age: "APARTMENTS", ageColor: "text-purple-600", title: "Apartment Units", description: "Contents-only plans for flat owners. Structure is typically covered by society — insure your interiors and belongings.", linkText: "Contents Plan", linkColor: "text-purple-600", bg: "bg-gradient-to-br from-purple-50 to-white" },
      { emoji: "/images/icons/independent-houses.png", age: "INDEPENDENT HOUSES", ageColor: "text-blue-600", title: "Independent Houses", description: "Full structure + contents cover. Rebuild cost insurance ensures you can reconstruct if the worst happens.", linkText: "Structure + Contents", linkColor: "text-blue-600", bg: "bg-gradient-to-br from-blue-50 to-white" },
      { emoji: "/images/icons/tenants.png", age: "RENTED HOMES", ageColor: "text-emerald-600", title: "Tenants", description: "Protect your contents — furniture, appliances, and personal belongings — even if you don't own the property.", linkText: "Tenant Contents Plan", linkColor: "text-emerald-600", bg: "bg-gradient-to-br from-emerald-50 to-white" },
      { emoji: "/images/icons/premium-properties.png", age: "HIGH-VALUE HOMES", ageColor: "text-cyan-600", title: "Premium Properties", description: "Bespoke policies for villas, luxury homes, and high-value contents including art, antiques, and jewellery.", linkText: "High-Value Home Plan", linkColor: "text-cyan-600", bg: "bg-gradient-to-br from-cyan-50 to-white" },
    ],
  ...
  "marine-insurance": {
    ...
    benefits: [
      { iconBg: "bg-sky-100", emoji: "/images/icons/all-risk-transit-cover.png", title: "All-Risk Transit Cover", description: "Covers loss or damage to cargo by sea, air, road, or rail — from the supplier's warehouse to the final destination." },
      { iconBg: "bg-blue-100", emoji: "/images/icons/open-annual-policies.png", title: "Open / Annual Policies", description: "Cover every shipment in a year under one contract. Declare consignments as they move — no per-shipment paperwork." },
      { iconBg: "bg-indigo-100", emoji: "/images/icons/natural-calamity-cover.png", title: "Natural Calamity Cover", description: "Protection against storms, cyclones, flooding, and other Acts of God that can damage or sink cargo in transit." },
      { iconBg: "bg-cyan-100", emoji: "/images/icons/general-average.png", title: "General Average", description: "Covers your share of losses when cargo is deliberately sacrificed or expenses incurred to save the whole voyage." },
      { iconBg: "bg-teal-100", emoji: "/images/icons/fire-theft-pilferage.png", title: "Fire, Theft & Pilferage", description: "Covers loss from fire, theft, non-delivery, and pilferage — common risks in multi-leg international shipping." },
      { iconBg: "bg-emerald-100", emoji: "/images/icons/warehouse-to-warehouse.png", title: "Warehouse-to-Warehouse", description: "Cover begins at the origin warehouse and ends at the destination — the full door-to-door journey is protected." },
      { iconBg: "bg-orange-100", emoji: "/images/icons/incoterms-aligned.png", title: "Incoterms Aligned", description: "Cover structured to your CIF, FOB, or EXW terms so the risk is insured by the right party at the right time." },
      { iconBg: "bg-rose-100", emoji: "/images/icons/fast-claims-settlement.png", title: "Fast Claims Settlement", description: "Surveyor-backed claims process with global support, so a damaged consignment is assessed and settled quickly." },
    ],
    stagesBadge: "FOR EVERY KIND OF SHIPMENT",
    stagesTitle: "Marine cover for",
    stagesTitleAccent: "how you trade",
    stages: [
      { emoji: "/images/icons/imports.png", age: "IMPORTERS", ageColor: "text-sky-600", title: "Imports", description: "Cover incoming consignments from overseas suppliers — sea or air — against transit loss and customs-stage damage.", linkText: "Import Cargo Plan", linkColor: "text-sky-600", bg: "bg-gradient-to-br from-sky-50 to-white" },
      { emoji: "/images/icons/exports.png", age: "EXPORTERS", ageColor: "text-blue-600", title: "Exports", description: "Protect outbound shipments to global buyers. CIF cover that meets your buyer's contractual insurance requirements.", linkText: "Export Cargo Plan", linkColor: "text-blue-600", bg: "bg-gradient-to-br from-blue-50 to-white" },
      { emoji: "/images/icons/inland-transit.png", age: "DOMESTIC TRADERS", ageColor: "text-indigo-600", title: "Inland Transit", description: "Cover for goods moving within India by road or rail — ideal for manufacturers and distributors with regular dispatches.", linkText: "Inland Transit Plan", linkColor: "text-indigo-600", bg: "bg-gradient-to-br from-indigo-50 to-white" },
      { emoji: "/images/icons/open-policies.png", age: "REGULAR SHIPPERS", ageColor: "text-cyan-600", title: "Open Policies", description: "High-volume traders cover all annual shipments under one declared open policy — simple, continuous protection.", linkText: "Open Marine Policy", linkColor: "text-cyan-600", bg: "bg-gradient-to-br from-cyan-50 to-white" },
    ],
  ...
  "fire-insurance": {
    ...
    benefits: [
      { iconBg: "bg-red-100", emoji: "/images/icons/fire-lightning.png", title: "Fire & Lightning", description: "Covers damage to building, plant, machinery, and stock from fire and lightning strikes — the core of the policy." },
      { iconBg: "bg-orange-100", emoji: "/images/icons/explosion-implosion.png", title: "Explosion & Implosion", description: "Damage caused by explosion or implosion of boilers, gas, and other equipment is covered under the standard policy." },
      { iconBg: "bg-yellow-100", emoji: "/images/icons/storm-cyclone-flood.png", title: "Storm, Cyclone & Flood", description: "Natural perils — storm, tempest, flood, inundation, hurricane, and cyclone — are all covered as named perils." },
      { iconBg: "bg-amber-100", emoji: "/images/icons/earthquake-addon.png", title: "Earthquake (Add-on)", description: "Earthquake and volcanic eruption cover can be added to protect against seismic damage to property and contents." },
      { iconBg: "bg-rose-100", emoji: "/images/icons/riot-strike-malicious-damage.png", title: "Riot, Strike & Malicious Damage", description: "Covers damage to property from riots, strikes, and deliberate malicious acts by external parties." },
      { iconBg: "bg-blue-100", emoji: "/images/icons/bursting-water-tanks.png", title: "Bursting of Water Tanks", description: "Damage from bursting or overflowing of water tanks, apparatus, and pipes is included in the cover." },
      { iconBg: "bg-indigo-100", emoji: "/images/icons/impact-damage.png", title: "Impact Damage", description: "Covers damage caused by impact from vehicles, aircraft, or other external objects falling on the insured property." },
      { iconBg: "bg-emerald-100", emoji: "/images/icons/loss-of-profit-addon.png", title: "Loss of Profit (Add-on)", description: "Business interruption cover replaces lost profit and standing charges while you rebuild after an insured fire." },
    ],
    stagesBadge: "FOR EVERY KIND OF PREMISES",
    stagesTitle: "Fire cover for",
    stagesTitleAccent: "every business",
    stages: [
      { emoji: "/images/icons/manufacturing-units.png", age: "FACTORIES", ageColor: "text-red-600", title: "Manufacturing Units", description: "Cover building, plant, machinery, raw material, and finished stock against fire and allied perils under one policy.", linkText: "Factory Fire Plan", linkColor: "text-red-600", bg: "bg-gradient-to-br from-red-50 to-white" },
      { emoji: "/images/icons/shops-showrooms.png", age: "SHOPS & RETAIL", ageColor: "text-orange-500", title: "Shops & Showrooms", description: "Protect your premises, fittings, and inventory. Essential for retailers carrying high-value stock on the floor.", linkText: "Shopkeeper Fire Plan", linkColor: "text-orange-500", bg: "bg-gradient-to-br from-orange-50 to-white" },
      { emoji: "/images/icons/godowns-warehouses.png", age: "WAREHOUSES", ageColor: "text-amber-600", title: "Godowns & Warehouses", description: "Cover large stockholdings against fire, flood, and theft. Declaration policies handle fluctuating inventory value.", linkText: "Warehouse Fire Plan", linkColor: "text-amber-600", bg: "bg-gradient-to-br from-amber-50 to-white" },
      { emoji: "/images/icons/offices-it-parks.png", age: "OFFICES", ageColor: "text-emerald-600", title: "Offices & IT Parks", description: "Protect office buildings, furniture, electronics, and equipment from fire, electrical faults, and natural perils.", linkText: "Office Fire Plan", linkColor: "text-emerald-600", bg: "bg-gradient-to-br from-emerald-50 to-white" },
    ],
  ...
  "miscellaneous-insurance": {
    ...
    benefits: [
      { iconBg: "bg-indigo-100", emoji: "/images/icons/burglary-housebreaking.png", title: "Burglary & Housebreaking", description: "Covers loss of property, stock, and valuables due to burglary, theft, or housebreaking from your premises." },
      { iconBg: "bg-violet-100", emoji: "/images/icons/fidelity-guarantee.png", title: "Fidelity Guarantee", description: "Protects your business against financial loss from fraud, embezzlement, or dishonesty by your own employees." },
      { iconBg: "bg-blue-100", emoji: "/images/icons/money-in-transit.png", title: "Money in Transit", description: "Covers cash, cheques, and valuables against loss or theft while being carried between premises, bank, or sites." },
      { iconBg: "bg-cyan-100", emoji: "/images/icons/machinery-breakdown.png", title: "Machinery Breakdown", description: "Covers sudden, unforeseen mechanical or electrical breakdown of plant and machinery, including repair costs." },
      { iconBg: "bg-emerald-100", emoji: "/images/icons/professional-indemnity.png", title: "Professional Indemnity", description: "Protects doctors, architects, consultants, and CAs against claims of negligence or errors in professional service." },
      { iconBg: "bg-rose-100", emoji: "/images/icons/public-liability.png", title: "Public Liability", description: "Covers legal liability for third-party injury or property damage arising from your business operations or premises." },
      { iconBg: "bg-orange-100", emoji: "/images/icons/electronic-equipment.png", title: "Electronic Equipment", description: "All-risk cover for computers, servers, medical devices, and sensitive electronics against damage and breakdown." },
      { iconBg: "bg-teal-100", emoji: "/images/icons/workmens-compensation.png", title: "Workmen's Compensation", description: "Covers your statutory liability to pay compensation to employees for work-related injury, disability, or death." },
    ],
    stagesBadge: "WHO NEEDS THESE COVERS",
    stagesTitle: "Tailored protection for",
    stagesTitleAccent: "specific risks",
    stages: [
      { emoji: "/images/icons/smes-enterprises.png", age: "BUSINESSES", ageColor: "text-indigo-600", title: "SMEs & Enterprises", description: "Burglary, fidelity, money-in-transit, and public liability — cover the operational risks every business carries.", linkText: "Business Risk Pack", linkColor: "text-indigo-600", bg: "bg-gradient-to-br from-indigo-50 to-white" },
      { emoji: "/images/icons/doctors-consultants.png", age: "PROFESSIONALS", ageColor: "text-blue-600", title: "Doctors & Consultants", description: "Professional indemnity protects against negligence claims — essential for medical, legal, and advisory practices.", linkText: "Professional Indemnity", linkColor: "text-blue-600", bg: "bg-gradient-to-br from-blue-50 to-white" },
      { emoji: "/images/icons/factories-plants.png", age: "MANUFACTURERS", ageColor: "text-violet-600", title: "Factories & Plants", description: "Machinery breakdown and electronic equipment cover keep production running when critical equipment fails.", linkText: "Machinery Cover", linkColor: "text-violet-600", bg: "bg-gradient-to-br from-violet-50 to-white" },
      { emoji: "/images/icons/shops-establishments.png", age: "RETAILERS", ageColor: "text-emerald-600", title: "Shops & Establishments", description: "Burglary and money-in-transit cover protect retail cash, stock, and daily banking from theft and loss.", linkText: "Shopkeeper Pack", linkColor: "text-emerald-600", bg: "bg-gradient-to-br from-emerald-50 to-white" },
    ],
  ...
  "entertainment-insurance": {
    ...
    benefits: [
      { iconBg: "bg-purple-100", emoji: "/images/icons/production-cancellation.png", title: "Production Cancellation", description: "Covers costs if a shoot or event is cancelled, postponed, or abandoned due to insured causes beyond your control." },
      { iconBg: "bg-violet-100", emoji: "/images/icons/cast-non-appearance.png", title: "Cast Non-Appearance", description: "Covers extra costs and losses if a key cast member can't appear due to illness, injury, or death during production." },
      { iconBg: "bg-fuchsia-100", emoji: "/images/icons/equipment-gear.png", title: "Equipment & Gear", description: "All-risk cover for cameras, lighting, sound, and rented gear against damage, theft, and loss on set or in transit." },
      { iconBg: "bg-pink-100", emoji: "/images/icons/weather-disruption.png", title: "Weather Disruption", description: "Covers losses from rain, storm, or adverse weather that forces cancellation of outdoor shoots and live events." },
      { iconBg: "bg-rose-100", emoji: "/images/icons/public-liability-event.png", title: "Public Liability", description: "Covers third-party injury or property damage at your event or set — essential for concerts and public venues." },
      { iconBg: "bg-indigo-100", emoji: "/images/icons/event-cancellation.png", title: "Event Cancellation", description: "Refund and cost cover for concerts, shows, and live events cancelled due to insured perils, including no-shows." },
      { iconBg: "bg-blue-100", emoji: "/images/icons/negative-footage-loss.png", title: "Negative & Footage Loss", description: "Covers the cost of re-shooting if exposed film, digital footage, or recordings are lost or damaged before edit." },
      { iconBg: "bg-emerald-100", emoji: "/images/icons/crew-workers-cover.png", title: "Crew & Workers' Cover", description: "Personal accident and workmen's compensation for cast, crew, and technicians working on your production." },
    ],
    stagesBadge: "FOR EVERY PRODUCTION",
    stagesTitle: "Cover designed for",
    stagesTitleAccent: "how you create",
    stages: [
      { emoji: "/images/icons/film-tv-production.png", age: "FILM & TV", ageColor: "text-purple-600", title: "Film & TV Production", description: "Full production cover — cast, equipment, negative loss, and cancellation — for features, series, and ad films.", linkText: "Film Production Plan", linkColor: "text-purple-600", bg: "bg-gradient-to-br from-purple-50 to-white" },
      { emoji: "/images/icons/concerts-shows.png", age: "LIVE EVENTS", ageColor: "text-violet-600", title: "Concerts & Shows", description: "Event cancellation, public liability, and weather cover for concerts, festivals, and live performances.", linkText: "Event Cover Plan", linkColor: "text-violet-600", bg: "bg-gradient-to-br from-violet-50 to-white" },
      { emoji: "/images/icons/broadcast-streaming.png", age: "BROADCAST", ageColor: "text-fuchsia-600", title: "Broadcast & Streaming", description: "Cover for studio shoots, live broadcasts, and streaming productions, including equipment and liability.", linkText: "Broadcast Plan", linkColor: "text-fuchsia-600", bg: "bg-gradient-to-br from-fuchsia-50 to-white" },
      { emoji: "/images/icons/exhibitions-fairs.png", age: "EXHIBITIONS", ageColor: "text-pink-600", title: "Exhibitions & Fairs", description: "Public liability and cancellation cover for trade shows, exhibitions, weddings, and large public gatherings.", linkText: "Exhibition Plan", linkColor: "text-pink-600", bg: "bg-gradient-to-br from-pink-50 to-white" },
    ],
