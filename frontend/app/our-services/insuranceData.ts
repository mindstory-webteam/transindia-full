...
export const INSURANCE_DATA: Record<string, InsuranceDetailData> = {
  ...
  "marine-insurance": {
    ...
    benefits: [
      { iconBg: "bg-sky-100", emoji: "🚢", title: "All-Risk Transit Cover", description: "Covers loss or damage to cargo by sea, air, road, or rail — from the supplier's warehouse to the final destination." },
      { iconBg: "bg-blue-100", emoji: "📦", title: "Open / Annual Policies", description: "Cover every shipment in a year under one contract. Declare consignments as they move — no per-shipment paperwork." },
      { iconBg: "bg-indigo-100", emoji: "🌊", title: "Natural Calamity Cover", description: "Protection against storms, cyclones, flooding, and other Acts of God that can damage or sink cargo in transit." },
      { iconBg: "bg-cyan-100", emoji: "⚖️", title: "General Average", description: "Covers your share of losses when cargo is deliberately sacrificed or expenses incurred to save the whole voyage." },
      { iconBg: "bg-teal-100", emoji: "🔥", title: "Fire, Theft & Pilferage", description: "Covers loss from fire, theft, non-delivery, and pilferage — common risks in multi-leg international shipping." },
      { iconBg: "bg-emerald-100", emoji: "🏭", title: "Warehouse-to-Warehouse", description: "Cover begins at the origin warehouse and ends at the destination — the full door-to-door journey is protected." },
      { iconBg: "bg-orange-100", emoji: "📄", title: "Incoterms Aligned", description: "Cover structured to your CIF, FOB, or EXW terms so the risk is insured by the right party at the right time." },
      { iconBg: "bg-rose-100", emoji: "💼", title: "Fast Claims Settlement", description: "Surveyor-backed claims process with global support, so a damaged consignment is assessed and settled quickly." },
    ],
    stagesBadge: "FOR EVERY KIND OF SHIPMENT",
    stagesTitle: "Marine cover for",
    stagesTitleAccent: "how you trade",
    stages: [
      { emoji: "🌍", age: "IMPORTERS", ageColor: "text-sky-600", title: "Imports", description: "Cover incoming consignments from overseas suppliers — sea or air — against transit loss and customs-stage damage.", linkText: "Import Cargo Plan", linkColor: "text-sky-600", bg: "bg-gradient-to-br from-sky-50 to-white" },
      { emoji: "🚢", age: "EXPORTERS", ageColor: "text-blue-600", title: "Exports", description: "Protect outbound shipments to global buyers. CIF cover that meets your buyer's contractual insurance requirements.", linkText: "Export Cargo Plan", linkColor: "text-blue-600", bg: "bg-gradient-to-br from-blue-50 to-white" },
      { emoji: "🚛", age: "DOMESTIC TRADERS", ageColor: "text-indigo-600", title: "Inland Transit", description: "Cover for goods moving within India by road or rail — ideal for manufacturers and distributors with regular dispatches.", linkText: "Inland Transit Plan", linkColor: "text-indigo-600", bg: "bg-gradient-to-br from-indigo-50 to-white" },
      { emoji: "📋", age: "REGULAR SHIPPERS", ageColor: "text-cyan-600", title: "Open Policies", description: "High-volume traders cover all annual shipments under one declared open policy — simple, continuous protection.", linkText: "Open Marine Policy", linkColor: "text-cyan-600", bg: "bg-gradient-to-br from-cyan-50 to-white" },
    ],
  ...
  "fire-insurance": {
    ...
    benefits: [
      { iconBg: "bg-red-100", emoji: "🔥", title: "Fire & Lightning", description: "Covers damage to building, plant, machinery, and stock from fire and lightning strikes — the core of the policy." },
      { iconBg: "bg-orange-100", emoji: "💥", title: "Explosion & Implosion", description: "Damage caused by explosion or implosion of boilers, gas, and other equipment is covered under the standard policy." },
      { iconBg: "bg-yellow-100", emoji: "🌪️", title: "Storm, Cyclone & Flood", description: "Natural perils — storm, tempest, flood, inundation, hurricane, and cyclone — are all covered as named perils." },
      { iconBg: "bg-amber-100", emoji: "🌍", title: "Earthquake (Add-on)", description: "Earthquake and volcanic eruption cover can be added to protect against seismic damage to property and contents." },
      { iconBg: "bg-rose-100", emoji: "✊", title: "Riot, Strike & Malicious Damage", description: "Covers damage to property from riots, strikes, and deliberate malicious acts by external parties." },
      { iconBg: "bg-blue-100", emoji: "🚿", title: "Bursting of Water Tanks", description: "Damage from bursting or overflowing of water tanks, apparatus, and pipes is included in the cover." },
      { iconBg: "bg-indigo-100", emoji: "✈️", title: "Impact Damage", description: "Covers damage caused by impact from vehicles, aircraft, or other external objects falling on the insured property." },
      { iconBg: "bg-emerald-100", emoji: "📉", title: "Loss of Profit (Add-on)", description: "Business interruption cover replaces lost profit and standing charges while you rebuild after an insured fire." },
    ],
    stagesBadge: "FOR EVERY KIND OF PREMISES",
    stagesTitle: "Fire cover for",
    stagesTitleAccent: "every business",
    stages: [
      { emoji: "🏭", age: "FACTORIES", ageColor: "text-red-600", title: "Manufacturing Units", description: "Cover building, plant, machinery, raw material, and finished stock against fire and allied perils under one policy.", linkText: "Factory Fire Plan", linkColor: "text-red-600", bg: "bg-gradient-to-br from-red-50 to-white" },
      { emoji: "🏪", age: "SHOPS & RETAIL", ageColor: "text-orange-500", title: "Shops & Showrooms", description: "Protect your premises, fittings, and inventory. Essential for retailers carrying high-value stock on the floor.", linkText: "Shopkeeper Fire Plan", linkColor: "text-orange-500", bg: "bg-gradient-to-br from-orange-50 to-white" },
      { emoji: "📦", age: "WAREHOUSES", ageColor: "text-amber-600", title: "Godowns & Warehouses", description: "Cover large stockholdings against fire, flood, and theft. Declaration policies handle fluctuating inventory value.", linkText: "Warehouse Fire Plan", linkColor: "text-amber-600", bg: "bg-gradient-to-br from-amber-50 to-white" },
      { emoji: "🏢", age: "OFFICES", ageColor: "text-emerald-600", title: "Offices & IT Parks", description: "Protect office buildings, furniture, electronics, and equipment from fire, electrical faults, and natural perils.", linkText: "Office Fire Plan", linkColor: "text-emerald-600", bg: "bg-gradient-to-br from-emerald-50 to-white" },
    ],
  ...
  "miscellaneous-insurance": {
    ...
    benefits: [
      { iconBg: "bg-indigo-100", emoji: "🔐", title: "Burglary & Housebreaking", description: "Covers loss of property, stock, and valuables due to burglary, theft, or housebreaking from your premises." },
      { iconBg: "bg-violet-100", emoji: "🤝", title: "Fidelity Guarantee", description: "Protects your business against financial loss from fraud, embezzlement, or dishonesty by your own employees." },
      { iconBg: "bg-blue-100", emoji: "💵", title: "Money in Transit", description: "Covers cash, cheques, and valuables against loss or theft while being carried between premises, bank, or sites." },
      { iconBg: "bg-cyan-100", emoji: "⚙️", title: "Machinery Breakdown", description: "Covers sudden, unforeseen mechanical or electrical breakdown of plant and machinery, including repair costs." },
      { iconBg: "bg-emerald-100", emoji: "📋", title: "Professional Indemnity", description: "Protects doctors, architects, consultants, and CAs against claims of negligence or errors in professional service." },
      { iconBg: "bg-rose-100", emoji: "⚖️", title: "Public Liability", description: "Covers legal liability for third-party injury or property damage arising from your business operations or premises." },
      { iconBg: "bg-orange-100", emoji: "🔧", title: "Electronic Equipment", description: "All-risk cover for computers, servers, medical devices, and sensitive electronics against damage and breakdown." },
      { iconBg: "bg-teal-100", emoji: "👷", title: "Workmen's Compensation", description: "Covers your statutory liability to pay compensation to employees for work-related injury, disability, or death." },
    ],
    stagesBadge: "WHO NEEDS THESE COVERS",
    stagesTitle: "Tailored protection for",
    stagesTitleAccent: "specific risks",
    stages: [
      { emoji: "🏢", age: "BUSINESSES", ageColor: "text-indigo-600", title: "SMEs & Enterprises", description: "Burglary, fidelity, money-in-transit, and public liability — cover the operational risks every business carries.", linkText: "Business Risk Pack", linkColor: "text-indigo-600", bg: "bg-gradient-to-br from-indigo-50 to-white" },
      { emoji: "👨‍⚕️", age: "PROFESSIONALS", ageColor: "text-blue-600", title: "Doctors & Consultants", description: "Professional indemnity protects against negligence claims — essential for medical, legal, and advisory practices.", linkText: "Professional Indemnity", linkColor: "text-blue-600", bg: "bg-gradient-to-br from-blue-50 to-white" },
      { emoji: "🏗️", age: "MANUFACTURERS", ageColor: "text-violet-600", title: "Factories & Plants", description: "Machinery breakdown and electronic equipment cover keep production running when critical equipment fails.", linkText: "Machinery Cover", linkColor: "text-violet-600", bg: "bg-gradient-to-br from-violet-50 to-white" },
      { emoji: "🛒", age: "RETAILERS", ageColor: "text-emerald-600", title: "Shops & Establishments", description: "Burglary and money-in-transit cover protect retail cash, stock, and daily banking from theft and loss.", linkText: "Shopkeeper Pack", linkColor: "text-emerald-600", bg: "bg-gradient-to-br from-emerald-50 to-white" },
    ],
  ...
  "entertainment-insurance": {
    ...
    benefits: [
      { iconBg: "bg-purple-100", emoji: "🎬", title: "Production Cancellation", description: "Covers costs if a shoot or event is cancelled, postponed, or abandoned due to insured causes beyond your control." },
      { iconBg: "bg-violet-100", emoji: "🌟", title: "Cast Non-Appearance", description: "Covers extra costs and losses if a key cast member can't appear due to illness, injury, or death during production." },
      { iconBg: "bg-fuchsia-100", emoji: "🎥", title: "Equipment & Gear", description: "All-risk cover for cameras, lighting, sound, and rented gear against damage, theft, and loss on set or in transit." },
      { iconBg: "bg-pink-100", emoji: "⛈️", title: "Weather Disruption", description: "Covers losses from rain, storm, or adverse weather that forces cancellation of outdoor shoots and live events." },
      { iconBg: "bg-rose-100", emoji: "⚖️", title: "Public Liability", description: "Covers third-party injury or property damage at your event or set — essential for concerts and public venues." },
      { iconBg: "bg-indigo-100", emoji: "🎟️", title: "Event Cancellation", description: "Refund and cost cover for concerts, shows, and live events cancelled due to insured perils, including no-shows." },
      { iconBg: "bg-blue-100", emoji: "📹", title: "Negative & Footage Loss", description: "Covers the cost of re-shooting if exposed film, digital footage, or recordings are lost or damaged before edit." },
      { iconBg: "bg-emerald-100", emoji: "👷", title: "Crew & Workers' Cover", description: "Personal accident and workmen's compensation for cast, crew, and technicians working on your production." },
    ],
    stagesBadge: "FOR EVERY PRODUCTION",
    stagesTitle: "Cover designed for",
    stagesTitleAccent: "how you create",
    stages: [
      { emoji: "🎞️", age: "FILM & TV", ageColor: "text-purple-600", title: "Film & TV Production", description: "Full production cover — cast, equipment, negative loss, and cancellation — for features, series, and ad films.", linkText: "Film Production Plan", linkColor: "text-purple-600", bg: "bg-gradient-to-br from-purple-50 to-white" },
      { emoji: "🎤", age: "LIVE EVENTS", ageColor: "text-violet-600", title: "Concerts & Shows", description: "Event cancellation, public liability, and weather cover for concerts, festivals, and live performances.", linkText: "Event Cover Plan", linkColor: "text-violet-600", bg: "bg-gradient-to-br from-violet-50 to-white" },
      { emoji: "📺", age: "BROADCAST", ageColor: "text-fuchsia-600", title: "Broadcast & Streaming", description: "Cover for studio shoots, live broadcasts, and streaming productions, including equipment and liability.", linkText: "Broadcast Plan", linkColor: "text-fuchsia-600", bg: "bg-gradient-to-br from-fuchsia-50 to-white" },
      { emoji: "🎪", age: "EXHIBITIONS", ageColor: "text-pink-600", title: "Exhibitions & Fairs", description: "Public liability and cancellation cover for trade shows, exhibitions, weddings, and large public gatherings.", linkText: "Exhibition Plan", linkColor: "text-pink-600", bg: "bg-gradient-to-br from-pink-50 to-white" },
    ],
