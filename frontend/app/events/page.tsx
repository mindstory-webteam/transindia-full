...
export default function EventsPage({
  ...
  return (
    ...
    >
      ...
      {/* ───────────────────────── Navy Banner Hero ───────────────────────── */}
      <section className="ev-banner" style={{ padding: "150px 20px 90px" }}>
        <div style={{ maxWidth: "1180px", margin: "0 auto" }}>
          <div className="ev-banner-grid">
            {/* Left: text */}
            <div style={{ fontFamily: "'matterregular', sans-serif" }}>
              {/* Breadcrumb */}
              <div
                className="ev-banner-crumb"
                style={{
                  display: "flex",
                  alignItems: "center",
                  gap: 8,
              ...
              >
                <a href="/" className="ev-crumb-link" style={{ color: "rgba(255,255,255,0.55)", textDecoration: "none" }}>
                  Home
                </a>
                <span>›</span>
              ...
              <span
                style={{
                  ...
                  color: "#7FE3EC",
                  background: "rgba(45,185,196,0.14)",
                  border: "1px solid rgba(45,185,196,0.35)",
                  marginBottom: 22,
                }}
              >
                Stay Connected
              ...
              >
                Events, <span style={{ color: ACCENT }}>Workshops</span>{" "}
                <span style={{ color: TEAL }}>&amp; Webinars.</span>
              </h1>
              ...
              >
                Join our upcoming live sessions, hands-on workshops, and community meetups — and
                catch up on the ones you missed.
              </p>

              {/* CTAs */}
              <div className="ev-banner-actions" style={{ display: "flex", gap: 14, flexWrap: "wrap" }}>
                <a
                  href="#contact"
            ...
            {/* Right: image section */}
            <div className="ev-banner-img-wrap">
              <span className="ev-banner-glow" aria-hidden="true" />

              <img
                src={bannerImage}
                alt="TransIndia events"
                loading="eager"
              ...
              {/* Floating accent icons (decorative, like the reference banner) */}
              <span className="ev-float" style={{ top: "8%", left: "6%", animationDelay: "0s" }} aria-hidden="true">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                  <path d="M7 2v3M17 2v3M3 9h18M5 5h14a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V7a2 2 0 0 1 2-2Z" stroke={TEAL} strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
              </span>
              <span className="ev-float" style={{ top: "16%", right: "4%", animationDelay: "1.2s" }} aria-hidden="true">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                  <path d="M3 12h3l2-5 3 10 2-7 2 2h4" stroke="#fff" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
              </span>
              <span className="ev-float" style={{ bottom: "16%", left: "3%", animationDelay: "0.6s" }} aria-hidden="true">
                <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
                  <path d="M9 4h6M8 4a2 2 0 0 0-2 2v13a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2M9 12l2 2 4-4" stroke="#fff" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
              </span>
              <span className="ev-float" style={{ bottom: "10%", right: "7%", animationDelay: "1.8s" }} aria-hidden="true">
                <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
                  <path d="M12 3v2M3 12a9 9 0 0 1 18 0H3ZM12 12v7a2 2 0 0 0 4 0" stroke={ACCENT} strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
              </span>
            </div>
          </div>
